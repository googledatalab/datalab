...
// Declare an ambient external module for angular-route, which allows for it to be imported via
// "import angularRoute = require('angularRoute');"" rather than through a
// "<amd-dependency path='...'/>" reference
